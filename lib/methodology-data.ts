    ...
    subs: [
      {
        ...
        content:
          "End-to-end supply chain analytics — from procurement to delivery. Demand sensing, inventory optimization, supplier performance tracking, and logistics cost reduction through data-driven insights.",
        highlights: [
          "Demand Sensing",
      ...
      },
      {
        ...
        content:
          "Complete order lifecycle tracking from placement to fulfillment. Conversion funnel analysis, return rate prediction, order clustering, and revenue forecasting for e-commerce platforms.",
        highlights: [
          "Order Lifecycle",
          "Conversion Funnel",
          "Return Prediction",
      ...
      },
      {
        ...
        content:
          "Retrieval Augmented Generation for enterprise knowledge bases. Private deployment with Swiss data residency, powered by Azure OpenAI and pgvector. Intelligent search across documents, wikis, and internal data.",
        highlights: [
    ...
    subs: [
      {
        ...
        image: {
          ...
          alt: "Swiss law and compliance documents",
          credit: "Tingey Injury Law Firm",
          creditUrl: "https://unsplash.com/@tingeyinjurylawfirm",
        },
...
Compliance Risk Score = (Data Sensitivity × Processing Scale × Cross-border Factor) / Security Measures`,
        ...
        links: [
          {
            label: "🇨🇭 FADP Full Text (Fedlex)",
            url: "https://www.fedlex.admin.ch/eli/cc/2022/491/de",
          },
          {
            label: "🇨🇭 FDPIC Guidelines",
            url: "https://www.edoeb.admin.ch/edoeb/de/home.html",
          },
          {
            label: "🇨🇭 nDSG Overview",
            url: "https://www.kmu.admin.ch/kmu/de/home/fakten-trends/digitalisierung/datenschutz/neues-datenschutzgesetz-ndsg.html",
          },
        ],
      },
      {
...
SOC2 Trust Criteria = Security + Availability + Processing Integrity + Confidentiality + Privacy`,
        ...
        links: [
          ...
          {
            label: "🇨🇭 FINMA Cloud Guidelines",
            url: "https://www.finma.ch/en/news/2018/09/20180914-mm-rs-outsourcing/",
          },
          {
            label: "🇨🇭 FINMA Annual Report",
...
• No data leaves Swiss jurisdiction`,
        ...
        links: [
          ...
          {
            label: "🇨🇭 AWS Zurich Region",
            url: "https://aws.amazon.com/about-aws/global-infrastructure/regions_az/",
          },
          {
            label: "🇨🇭 Adequate Countries List",
            url: "https://www.edoeb.admin.ch/edoeb/de/home/datenschutz/handel-und-wirtschaft/uebermittlung-ins-ausland.html",
          },
        ],
      },
      {
    ...
    subs: [
      {
        ...
        image: {
          ...
          alt: "Team workshop with whiteboard",
...
Launch Readiness Score = Product × Marketing × Sales × Support`,
      ...
      },
      {
        ...
        image: {
          ...
          alt: "Customer feedback and satisfaction",
          credit: "Blake Wisz",
    ...
    subs: [
      {
        ...
        content:
          "Notion-based productivity system with weekly reviews, goal tracking, and habit management. Designed for developers and consultants.",
        highlights: [
          "Weekly Review",
          "Goal Tracking",
          "Habit System",
      ...
      },
      {
        ...
        content:
          "Structured knowledge management with tagging, linking, and progressive summarization. Never lose an insight again.",
        highlights: [
          "Zettelkasten",
          "Progressive Summary",
          "Tag System",
...
ROI = (Time Saved × Hourly Rate) - Implementation Cost`,
      ...
      },
      {
        ...
        pdfs: [
          {
            title: "Didi Service Blueprint",
            file: "/pdfs/didi-service-blueprint.pdf",
            desc: "Complete ride-hailing service flow: customer actions, front-stage interactions, back-stage processes, and support systems for Didi Chuxing.",
          },
          {
            title: "SAIC-GM Service Blueprint",
            file: "/pdfs/saic-gm-service-blueprint.pdf",
            desc: "Automotive after-sales service design: dealership touchpoints, maintenance workflow, customer communication, and quality assurance loops.",
          },
          {
            title: "OPPO Mobile — Customer Journey",
            file: "/pdfs/customer-journey.pdf",
            desc: "OPPO Mobile — End-to-end customer journey mapping: NPS research across user stages (potential, new, active, paying), touchpoint analysis, emotion curves, and experience optimization for the OPPO Internet reading app ecosystem.",
          },
        ],
        content: "",
...
• Storage: Snowflake, BigQuery, Redshift`,
      ...
      },
      {
        ...
        image: {
          ...
          alt: "Business intelligence charts",
          credit: "Carlos Muza",
...
• Lack of data literacy training`,
      ...
      },
      {
        ...
        image: {
          ...
          credit: "Adeolu Eletu",
          creditUrl: "https://unsplash.com/@adeolueletu",
        },
...
• Lack of sustained investment`,
      ...
      },
      {
        ...
        image: {
          ...
          alt: "Enterprise architecture blueprint",
          credit: "Campaign Creators",
          creditUrl: "https://unsplash.com/@campaign_creators",
        },
...
**Tools:** ArchiMate, Sparx EA, LeanIX, Ardoq`,
      ...
      },
      {
        ...
        image: {
          ...
          creditUrl: "https://unsplash.com/@domenicoloia",
        },
...
export function getCategoryAndSub(categoryId: string, subId: string) {
...
export function getAllMethodologyPaths() {
