...
export const searchProducts = [
  ...
  },
  {
    ...
    billingCycle: "yearly",
    description:
      "Collaborative interface design tool for teams. Design, prototype, and gather feedback.",
  ...
  },
  {
    ...
    billingCycle: "yearly",
    description:
      "Secure password manager for teams. Share passwords and sensitive data safely.",
