...
export const portfolioItems: PortfolioItem[] = [
  ...
  },
  {
    ...
    description:
      "Designed UI/UX for a user growth coins system and dashboard, driving user engagement and retention.",
    category: "design",
    subCategory: "UI/UX",
  ...
  },
  {
    ...
    description:
      "Led the design of TCL smart home application for iOS and Android, increasing new users by 20%.",
    category: "design",
    subCategory: "UI/UX",
  ...
  },
  {
    ...
    description:
      "Integrated electrical kitchen appliances into the digital strategy and mobile application solution.",
    category: "design",
    subCategory: "UI/UX",
  ...
  // Product — 产品管理项目
  {
    ...
    description:
      "Managed the development of an E-commerce SaaS dropshipping system from 0-1, defining KPIs across dimensions.",
    category: "product",
  ...
  },
  {
    ...
    description:
      "Built Brazil logistics ERP system from scratch, implementing NPS user growth strategies.",
    category: "product",
  ...
  },
  {
    ...
    description:
      "Analyzed Dutch market trends and customer behavior, boosting product visibility with Power BI KPI management.",
    category: "product",
  ...
  },
  {
    ...
    description:
      "Led AIxIoT and smart home product development, integrating R&D for electrical kitchen appliances.",
    category: "product",
  ...
  },
  {
    ...
    description:
      "Business strategy planning, competitor analysis, website development from design to deployment.",
    category: "product",
  ...
  // Development — 开发项目
  {
    ...
    description:
      "Swiss-compliant Azure RAG deployment with FADP/FINMA compliance. Enterprise AI infrastructure.",
  ...
  },
  {
    ...
    description:
      "Swiss EV charging subsidy explorer with interactive map and ROI calculator.",
    category: "development",
  ...
  },
  {
    ...
    description:
      "Software license management system with real-time status updates and admin dashboard.",
    category: "development",
  ...
  },
  {
    ...
    description:
      "Personal portfolio website with modern design, animations, and interactive elements.",
    category: "development",
  ...
  },
  {
    ...
    description:
      "Image optimization tool for e-commerce with Chrome extension and Shopify integration.",
    category: "development",
  ...
  },
  {
    ...
    description:
      "Master thesis on Generative AI-Assistant in E-Commerce Business at FHNW.",
    category: "development",
...
export const portfolioCategories = [
  { id: "", name: "All", count: portfolioItems.length },
  {
    id: "design",
    name: "Design",
    count: portfolioItems.filter((p) => p.category === "design").length,
  },
  {
    id: "product",
    name: "IT Products",
    count: portfolioItems.filter((p) => p.category === "product").length,
  },
  {
    id: "development",
    name: "Website",
    count: portfolioItems.filter((p) => p.category === "development").length,
  },
];
