  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="px-5 md:px-8 lg:px-20 pt-5 md:pt-[5px] pb-5 md:pb-6">
        <h1 className="text-[30px] font-bold tracking-tight mb-5 md:mb-6">
          All Work
        </h1>
        {/* Category Filters */}
              ...
              >
                ...
                {item.image ? (
                  <Image
                    ...
                    sizes={
                      isFullWidth
                        ? "(min-width: 768px) 821px, 100vw"
                        : "(min-width: 768px) 411px, 100vw"
                    }
                    quality={100}
                    ...
                    <div className="rounded-2xl bg-black/30 px-4 py-4 md:bg-transparent md:p-0">
                      <div className="flex items-end justify-between gap-6">
                        <div className="min-w-0 flex-1">
                          ...
                          <h3
                            className={`font-bold text-white mb-2 tracking-tight leading-tight ${isFullWidth ? "text-xl md:text-3xl" : "text-lg md:text-2xl"}`}
                          >
                            {item.title}
                          </h3>

                          <p
                            className={`text-white/70 leading-relaxed ${isFullWidth ? "text-sm md:text-base max-w-2xl" : "text-xs max-w-[90%]"}`}
                          >
                            {item.subtitle}
                          </p>
                        </div>
