  ...
  return (
    <div className="my-6 ml-5">
      <p className="text-[10px] tracking-[0.2em] text-neutral-400 mb-3">
        SEAN ELLIS TEST — EXAMPLE RESULT
      </p>
  ...
  return (
    <div className="my-6 ml-5">
      ...
      <svg width={w} height={h + 30} viewBox={`0 0 ${w} ${h + 30}`}>
        ...
        <text x={w - px + 5} y={toY(0)} fontSize="9" fill="#d4d4d4">
          No PMF
        </text>
        {[0, 3, 6, 9].map((i) => (
          <text
    ...
    <div className="my-6 ml-5">
      ...
      <div className="mt-4 flex items-center gap-2">
        ...
        <span className="text-[9px] text-neutral-400">
          Conversion drops at each stage
        </span>
        <div className="flex-1 h-[1px] bg-neutral-200" />
      </div>
    </div>
  ...
  const layers = [
    {
      ...
      desc: "What user does",
      color: "#000",
      items: ["Search", "Compare", "Purchase", "Use", "Review"],
    },
    {
      label: "Front-stage",
      desc: "Visible interactions",
      color: "#404040",
      items: ["Website", "App", "Support Chat", "Email"],
    },
    {
      label: "Back-stage",
      desc: "Internal processes",
      color: "#737373",
      items: ["Order Processing", "Inventory", "Shipping"],
    },
    {
      label: "Support",
      desc: "Systems & tools",
      color: "#a3a3a3",
      items: ["Database", "CRM", "Analytics"],
    },
  ];
  return (
    <div className="my-6 ml-5">
          ...
          >
            ...
            {i < layers.length - 1 && (
              <div className="ml-24 pl-3 my-1 border-l-2 border-dashed border-neutral-200 h-2 flex items-center">
                <span className="text-[7px] text-neutral-300 ml-2">
                  {i === 0
                    ? "Line of Interaction"
                    : i === 1
                      ? "Line of Visibility"
    ...
    <div className="my-6 ml-5">
      ...
      <div className="grid grid-cols-2 gap-x-6 gap-y-1.5 max-w-md">
        {heuristics.map((h, i) => (
          ...
          >
            <span className="text-[9px] font-mono text-neutral-300 w-4">
              {h.num}
            </span>
      ...
      <div className="mt-3 text-[9px] text-neutral-400">
        Average Score:{" "}
        {(heuristics.reduce((a, b) => a + b.score, 0) / 10).toFixed(1)} / 5
      </div>
    </div>
  );
}
...
export function DesignSystemChart() {
  const layers = [
    ...
    {
      name: "Molecules",
      items: ["Form Field", "Card", "List Item"],
      color: "#737373",
    },
            ...
            >
              <div className="flex flex-wrap gap-0.5 justify-center">
                {layer.items.map((item, j) => (
                  <span
                    key={j}
                    className="text-[6px] text-white/80 bg-white/20 rounded px-1"
                  >
                    {item}
                  </span>
                ))}
...
export function ResearchMethodsChart() {
  ...
  return (
    <div className="my-6 ml-5">
      <p className="text-[10px] tracking-[0.2em] text-neutral-400 mb-3">
        RESEARCH METHODS — EFFORT vs INSIGHT DEPTH
      </p>
      <svg width={w} height={h + 20} viewBox={`0 0 ${w} ${h + 20}`}>
        ...
        <text x={w - 90} y={18} fontSize="8" fill="#737373">
          Qualitative
        </text>
        <circle
          cx={w - 100}
          ...
          strokeWidth="1.5"
        />
        <text x={w - 90} y={33} fontSize="8" fill="#737373">
          Quantitative
        </text>
      </svg>
    </div>
