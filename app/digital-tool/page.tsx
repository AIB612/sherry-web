...
const assessmentCategories = [
  {
    ...
    description:
      "Digital vision, leadership commitment, and strategic alignment",
    questions: [
      {
        id: "s1",
  ...
  },
  {
    ...
    description:
      "IT systems, cloud adoption, data management, and cybersecurity",
    questions: [
      {
        id: "t1",
        ...
        options: [
          ...
          {
            value: 5,
            label: "Cloud-native architecture with multi-cloud strategy",
          },
        ],
      },
      {
    ...
    questions: [
      {
        ...
        options: [
          ...
          {
            value: 5,
            label: "Digital-native workforce with innovation mindset",
          },
        ],
      },
      {
        ...
        options: [
          ...
          {
            value: 5,
            label: "Culture of continuous innovation and experimentation",
          },
        ],
      },
      {
        ...
        options: [
          ...
          {
            value: 5,
            label: "Continuous learning with personalized development paths",
          },
        ],
      },
    ],
  },
  {
    ...
    title: "Product & UX",
    description:
      "Product-Market Fit, UX measurement (HEART/NPS), and customer-centricity",
    questions: [
      {
        id: "ux1",
        ...
        options: [
          ...
          {
            value: 5,
            label: "Strong focus on PMF with continuous market validation",
          },
        ],
      },
      {
        ...
        options: [
          ...
          {
            value: 5,
            label: "Predictive real-time UX analytics driving all decisions",
          },
        ],
      },
      {
        ...
        options: [
          ...
          {
            value: 3,
            label: "Regular user interviews and structured feedback loops",
          },
          {
            value: 4,
            label:
              "Cross-functional teams actively participate in user research",
          },
          {
            value: 5,
            label:
              "Deep customer-centric culture; empathy drives every feature",
          },
        ],
      },
    ],
...
const maturityLevels = [
  {
    ...
    max: 15,
    level: "Initial",
    description: "Ad-hoc processes, limited digital awareness",
  },
  {
    min: 16,
    max: 30,
    level: "Developing",
    description: "Basic digital capabilities, some initiatives",
  },
  {
    min: 31,
    max: 45,
    level: "Defined",
    description: "Structured approach, moderate maturity",
  },
  {
    min: 46,
    max: 60,
    level: "Managed",
    description: "Measured processes, good maturity",
  },
  {
    min: 61,
    max: 75,
    level: "Optimizing",
    description: "Continuous improvement, digital leader",
  },
];
...
export default function DigitalToolPage() {
  ...
  useEffect(() => {
    ...
    const handleHashChange = () => {
      ...
      const nextStep = hashToStep(hash);
      if (nextStep) setStep(nextStep as typeof step);
    };
    ...
    <>
      ...
      <div className="hidden xl:flex fixed left-6 top-1/2 -translate-y-1/2 z-40 flex-col items-start gap-3">
        {[
          ...
          return (
            ...
            >
              ...
              />
              <span
                className={`text-[10px] tracking-[0.25em] uppercase font-medium font-sans transition-colors duration-300 ${
        ...
        <button
          ...
          onClick={() => {
            const shareStep =
              step === ("assessment-run" as never) || step === "results"
                ? "assessment"
                : step;
            const url = `${window.location.origin}${window.location.pathname}#${shareStep}`;
            navigator.clipboard.writeText(url);
            alert("Link copied to clipboard!");
          }}
          className="mt-2 ml-[38px] flex items-center gap-1.5 text-[10px] tracking-[0.2em] uppercase text-neutral-400 hover:text-black transition-colors"
      ...
      <div className="flex-grow flex items-center justify-center px-5 py-12 md:px-8 lg:px-20 bg-white">
          ...
          >
            <div className="space-y-4 mb-4">
              ...
              <p className="text-sm md:text-base text-neutral-500 max-w-2xl mx-auto leading-relaxed font-sans">
                Discover your organization's maturity across Strategy,
                Technology, Process, People, and UX. Based on academic research
            ...
            <div className="mt-4">
              <button
                onClick={() => {
                  setAnswers({});
                  setCurrentIndex(0);
                  setStep("assessment-run" as never);
                }}
        ...
        {/* STEP 2B: ASSESSMENT QUESTIONS */}
        {step === ("assessment-run" as never) && currentQuestion && (
          <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
            ...
            <div className="hidden lg:flex flex-col items-center justify-center p-8 bg-neutral-50/50 rounded-sm border border-neutral-100 h-[480px] w-full overflow-visible">
              <h3 className="text-[10px] tracking-[0.25em] font-medium mb-12 text-neutral-400 uppercase font-sans">
                Live Shape
              </h3>
                  ...
                  <div className="space-y-3 flex-grow overflow-y-auto pr-2 pb-4">
                    {currentQuestion.options.map((option) => {
                      ...
                      return (
                        ...
                        >
                          <div
                            className={`flex-shrink-0 w-7 h-7 rounded-full flex items-center justify-center text-[10px] font-bold tracking-widest transition-colors duration-300 ${
                              isSelected
                                ? "bg-white text-black"
          ...
          >
            <div className="grid grid-cols-1 lg:grid-cols-5">
              ...
              <div className="lg:col-span-2 p-12 bg-neutral-50/50 flex flex-col items-center justify-center border-r border-neutral-100 overflow-visible">
                <p className="text-[10px] tracking-[0.3em] font-medium text-neutral-400 uppercase mb-8 font-sans">
                  Digital Profile
                </p>
              ...
              <div className="lg:col-span-3 p-10 md:p-14 flex flex-col justify-center">
                {(() => {
                  ...
                  const categoryPerformance = assessmentCategories.map(
                    (cat, idx) => ({
                      id: cat.id,
                      title: cat.title,
                      score: categoryScores[idx] || 0,
                      percentage: Math.round(
                        ((categoryScores[idx] || 0) / 15) * 100,
                      ),
                    }),
                  );
                  ...
                  const weakest = categoryPerformance[
                    categoryPerformance.length - 1
                  ] || { id: "none", title: "N/A", score: 0, percentage: 0 };
                  ...
                  return (
                    <div className="space-y-10">
                      <div className="flex justify-between items-end border-b border-neutral-100 pb-8">
                        <div>
                          <div className="flex items-center gap-3 mb-3">
                            <p className="text-[10px] text-neutral-400 uppercase tracking-[0.3em] font-semibold font-sans">
                              Digital Maturity Index
                            </p>
                            <span className="text-[9px] px-2 py-0.5 bg-neutral-100 text-neutral-500 rounded-sm font-sans tracking-widest uppercase">
                              DMI
                            </span>
                          </div>
                          <div className="flex items-baseline gap-2">
                            <span className="text-6xl font-bold tracking-[-0.03em] text-black">
                              {overallPercentage}
                            </span>
                            <span className="text-xl text-neutral-300 font-medium font-sans">
                              / 100
                            </span>
                          </div>
                      ...
                      <div className="space-y-6">
                        <h3 className="text-[1.5rem] md:text-[2rem] font-bold tracking-[-0.03em] text-black">
                          Strategic Recommendations
                        </h3>
                        <p className="text-neutral-600 text-sm leading-relaxed font-sans">
                          Based on your Digital Maturity Index, your
                          organization is at the{" "}
                          <span className="font-semibold text-black">
                            {maturityLevel.level}
                          </span>{" "}
                          stage ({maturityLevel.description.toLowerCase()}). To
                          accelerate your transformation and maximize ROI, we
                          recommend prioritizing specific interventions in your
                          critical gap area:{" "}
                          <span className="font-semibold text-black">
                            {weakest.title}
                          </span>
                        ...
                        <div className="bg-neutral-50 border border-neutral-200 rounded-sm p-6 mt-6">
                          <h4 className="text-[11px] font-bold tracking-[0.1em] uppercase text-black mb-4 font-sans">
                            Priority Action Plan: {weakest.title}
                          </h4>
                          {weakest.id === "strategy" && (
                            <ul className="text-sm text-neutral-600 font-sans space-y-3 list-disc pl-4 marker:text-black">
                              <li>
                                ...
                                Form a cross-functional digital steering
                                committee to align your vision across all
                                departments.
                              </li>
                              <li>
                                <b className="font-medium text-black">
                                ...
                                Set 3-5 clear, measurable KPIs tying digital
                                initiatives directly to core business outcomes.
                              </li>
                              <li>
                                <b className="font-medium text-black">
                                  Transparent Roadmap:
                                </b>{" "}
                                Communicate the transformation strategy openly
                                to ensure organizational buy-in.
                              </li>
                            </ul>
                          )}
                          {weakest.id === "technology" && (
                            <ul className="text-sm text-neutral-600 font-sans space-y-3 list-disc pl-4 marker:text-black">
                              <li>
                                ...
                                Evaluate existing legacy systems to identify
                                urgent and high-impact cloud migration
                                candidates.
                              </li>
                              <li>
                                <b className="font-medium text-black">
                                ...
                                Establish a centralized data architecture to
                                break down silos and enable cross-departmental
                                analytics.
                              </li>
                              <li>
                                <b className="font-medium text-black">
                                ...
                                Implement a Zero-Trust architecture to secure
                                expanded and remote digital perimeters.
                              </li>
                            </ul>
                          )}
                          {weakest.id === "process" && (
                            <ul className="text-sm text-neutral-600 font-sans space-y-3 list-disc pl-4 marker:text-black">
                              <li>
                                ...
                                Map core operational flows to identify high-ROI
                                bottlenecks suitable for automation.
                              </li>
                              <li>
                                <b className="font-medium text-black">
                                  RPA Implementation:
                                </b>{" "}
                                Deploy Robotic Process Automation for
                                repetitive, high-volume manual workflows.
                              </li>
                              <li>
                                <b className="font-medium text-black">
                                  Agile Transition:
                                </b>{" "}
                                Shift from traditional waterfall project
                                management to iterative, enterprise-scale Agile
                                frameworks.
                              </li>
                            </ul>
                          )}
                          {weakest.id === "people" && (
                            <ul className="text-sm text-neutral-600 font-sans space-y-3 list-disc pl-4 marker:text-black">
                              <li>
                                ...
                                Launch continuous digital literacy training
                                targeted specifically at non-technical staff.
                              </li>
                              <li>
                                <b className="font-medium text-black">
                                  Innovation Culture:
                                </b>{" "}
                                Create an internal "Innovation Lab" or hackathon
                                series to foster a fail-fast, experimental
                                mindset.
                              </li>
                              <li>
                                <b className="font-medium text-black">
                                ...
                                Revise performance metrics to explicitly reward
                                digital tool adoption and cross-team
                                collaboration.
                              </li>
                            </ul>
                          )}
                          {weakest.id === "product-ux" && (
                            <ul className="text-sm text-neutral-600 font-sans space-y-3 list-disc pl-4 marker:text-black">
                              <li>
                                ...
                                Adopt the Google HEART framework to measure user
                                experience beyond basic operational metrics.
                              </li>
                              <li>
                                <b className="font-medium text-black">
                                  Continuous Discovery:
                                </b>{" "}
                                Integrate user feedback loops into weekly
                                development sprints rather than post-launch.
                              </li>
                              <li>
                                <b className="font-medium text-black">
                                  Outcome Roadmaps:
                                </b>{" "}
                                Transition from output-based roadmaps (features
                                shipped) to outcome-based roadmaps (problems
                                solved).
                              </li>
                            </ul>
                          )}
                          {(weakest.id === "none" ||
                            ...
                            <ul className="text-sm text-neutral-600 font-sans space-y-3 list-disc pl-4 marker:text-black">
                              <li>
                                ...
                                ecosystem to identify hidden bottlenecks.
                              </li>
                              <li>
                                <b className="font-medium text-black">
                                  Cross-Functional Alignment:
                                </b>{" "}
                                Ensure your IT, Product, and Business teams are
                                working toward the same digital KPIs.
                              </li>
                              <li>
                                <b className="font-medium text-black">
                                  Continuous Optimization:
                                </b>{" "}
                                Keep pushing the envelope with AI integration
                        ...
                        <div className="mt-8 space-y-4">
                          <h4 className="text-[11px] font-bold tracking-[0.1em] uppercase text-black font-sans mb-3">
                            Your Digital Profile Analysis
                          </h4>
                        ...
                        <div className="bg-neutral-50 border border-neutral-200 rounded-sm p-6 mt-6">
                          <h4 className="text-[11px] font-bold tracking-[0.1em] uppercase text-black mb-3 font-sans">
                            Product & UX Philosophy
                          </h4>
                          <p className="text-neutral-600 text-sm leading-relaxed font-sans">
                            True{" "}
                            <b className="font-serif text-black">
                              Product-Market Fit (PMF)
                            </b>{" "}
                            requires moving beyond basic PULSE metrics. By
                            implementing the{" "}
                            <b className="font-serif text-black">HEART</b>{" "}
                            framework and measuring{" "}
                            <b className="font-serif text-black">NPS/CES</b>,
                            you ensure your digital transformation actually
